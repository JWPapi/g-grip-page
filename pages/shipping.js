  ...
  return (
    <div className="pt-16">
      <article className="mx-auto prose my-16">
        ...
        <h1>Return Policy</h1>
        <p>
          Our policy is applicable for fourteen (14) days after you have received your order. If fourteen (14) days have
        ...
        <p> To be eligible for a refund, your item must be unused, undamaged and in the same condition that you received
        ...
        <p> Items that are returned to us as undeliverable or returned after three (3) delivery attempts will be treated
        ...
        <p> If you’ve done all of this and you still have not received your refund, please contact us at info@gwshop.uk.
