      ...
      <main>
              ...
              <div className="c-grid-2 lg:px-0">
                ...
                <div className="mt-4 md:mt-0">
                  <p>
                    ...
                    one-handed like a traditional&nbsp;camera. </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="c-grid-2 px-4 xl:px-0 mb-16">
            <div>
              ...
              <p>
                ...
                phone but missed the ergonomic grip and shutter of a camera – hence designing the&nbsp;G-Grip. </p>
            </div>
            <div>
              <p className="mt-4 md:mt-0">
                Greg says... <br/><br/> <span className="italic"> I shoot pictures on my phone everyday. I invented the G-Grip so I can operate
                                        it like a traditional&nbsp;camera.</span>
              </p>
              <p className="mt-4">Follow Greg on <a className="text-neutral-400"
                                                    href="https://www.instagram.com/gregwilliamsphotography/">Instagram</a>
              </p>
            </div>
          </div>
        </section>
        <section className="mt-16">
          ...
          <h2 className=" max-w-sm mx-auto text-center">
            hours battery life in normal use <br/> and 4,000 hours on standby. </h2>
          <h2 id="techspecs" className="anchor mt-16 md:mt-32">Technical specifications</h2>
